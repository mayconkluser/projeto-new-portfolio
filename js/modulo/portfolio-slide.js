...
export class PortfolioSlide {
  ...
  changeSlide(index) {
    ...
    this.changeActive();
    this.containerSlide.dispatchEvent(this.changeEvent);
  }
...
export default class SlideNav extends PortfolioSlide {
  constructor(slide, containerSlide) {
    super(slide, containerSlide);
  ...
  createControl() {
    ...
    this.containerSlide.appendChild(control);
    return control;
  }
  ...
  eventControl(item, index) {
    ...
    this.containerSlide.addEventListener("changeEvent", this.activeControlItem);
  }
